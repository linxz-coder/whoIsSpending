...
BASE_DIR="/Users/lxz/Downloads/谁在花钱日报"
ZOLA_DIR="/Users/lxz/Desktop/zola-basic"
...
- whoIsSpending local repo: /Users/lxz/Downloads/谁在花钱日报
- whoIsSpending remote: git@github.com:linxz-coder/whoIsSpending.git
- zola-basic local repo: /Users/lxz/Desktop/zola-basic
...
- Follow /Users/lxz/Downloads/谁在花钱日报/README.txt and /Users/lxz/Downloads/谁在花钱日报/新闻源清单.txt.
...
Required steps:
1. In /Users/lxz/Downloads/谁在花钱日报, pull latest origin/main with fast-forward only.
2. In /Users/lxz/Desktop/zola-basic, pull latest origin/main with fast-forward only.
3. Create or refresh /Users/lxz/Downloads/谁在花钱日报/${DAY}/ with:
   - 谁在花钱_素材池_${DAY}.txt
   - 谁在花钱_日报_${DAY}.txt
   - 谁在花钱_发布版_${DAY}.txt
   - 生成指令.txt
4. Write the Zola Markdown article:
   - /Users/lxz/Downloads/谁在花钱日报/${DAY}/github_sync_payload/content/blog/谁在花钱日报-${DAY}.md
   - /Users/lxz/Downloads/谁在花钱日报/github_sync_payload/content/blog/谁在花钱日报-${DAY}.md
   ...
   tags = ["日报", "商业", "投资", "高薪职位"]
   +++
5. Copy the Markdown article to /Users/lxz/Desktop/zola-basic/content/blog/谁在花钱日报-${DAY}.md.
6. Run zola build in /Users/lxz/Desktop/zola-basic if zola is available. If it creates or changes public/, do not commit public/.
